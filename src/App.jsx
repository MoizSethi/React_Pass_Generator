      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-700 text-orange-500">
        ...
        <div className="flex text-sm gap-x-2">
          <div className="flex items-center gap-x-1">
            ...
            <label className='text-white font-normal'>Length: <span className='font-bold'>{length}</span></label>
          </div>
          <div className="flex items-center gap-x-1">
            <input type="checkBox" defaultChecked={numberAllowed} id='numberInput' onChange={() => {
              setNumberAllowed((prev)=> !prev)
            }} />
            <label className='text-white font-normal' htmlFor="numberInput">Numbers</label>
          </div>
          <div className="flex items-center gap-x-1">
            <input type="checkBox" defaultChecked={charAllowed} id='charInput' onChange={() => {
              setCharAllowed((prev)=> !prev)
            }} />
            <label className='text-white font-normal' htmlFor="charInput">Characters</label>
          </div>
        </div>
      </div>
    </>
